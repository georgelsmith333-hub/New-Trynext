...
const HERO_PRODUCT_GRID = [
  ...
  { src: capSrc, label: "Custom Cap", badge: "Trending", badgeColor: "#7C3AED", delay: 0.3, floatY: 9, href: "/products?category=caps&sort=newest", surface: "rgba(255,246,237,0.98)" },
  ...
  { src: mugSrc, label: "Custom Mug", badge: "Popular", badgeColor: "#9333EA", delay: 0.35, floatY: 6, href: "/products?category=mugs&sort=bestsellers", surface: "rgba(255,246,237,0.98)" },
];
            ...
            >
              {HERO_PRODUCT_GRID.map((p, i) => (
                <Link
                  ...
                  style={{
                    width: "130px",
                   background: p.surface ?? "rgba(255,253,251,0.94)",
              ...
              >
                ...
                <motion.img
                  ...
                  onError={(e) => { (e.currentTarget as HTMLImageElement).src = tshirtSrc; }}
                   style={p.surface ? { filter: "drop-shadow(0 8px 10px rgba(90,47,20,0.18))" } : undefined}
